cd toosl/red; gcc robot.c -o robot; cd -
cp tools/red/robot.o ./nix/hosts/dashboard/robot.o
...
try {
  ...
  scp -r -P $port /home/noah/Projects/thesis/hotel/nix env-admin@localhost:/home/env-admin/nixos
